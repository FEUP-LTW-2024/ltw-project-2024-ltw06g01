...
CREATE TABLE LISTINGS(
    ...
    Sold TEXT CHECK (Sold IN ('true', 'false') ),
...
CREATE TABLE WISHLIST(
    ...
    FOREIGN KEY (IdListing) REFERENCES LISTINGS(IdListing) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE MESSAGE(
    ...
    message TEXT NOT NULL,
        FOREIGN KEY (Sender) REFERENCES USER(User) ON UPDATE CASCADE,
        FOREIGN KEY (Receiver) REFERENCES USER(User) ON UPDATE CASCADE
);
